...
export const FLASHCARDS: Card[] = [
    ...
    },
    {
        ...
        "front": "<p>Explain the following anatomical structures in lay terms:</p> <br>‘Tympanic Membrane’<br>‘Urethra’<br>‘Rectum’",
    ...
    },
    {
        ...
        "front": "<p>Describe to a patient how the following are carried out:</p> <br>Echocardiogram (Echo)<br>Electrocardiogram (ECG)",
        "back": "<p>1. <b>Echocardiogram</b> – An echo is an ultrasound scan of the heart, which works in a similar way to the ultrasound scan used to examine the tummy of a pregnant lady. The probe is pressed against the skin, on the left side of the chest, to gather information about how well the heart is beating. An echo shouldn’t be sore or uncomfortable and usually doesn’t take any prior preparation.</p> <p>2. <b>Electrocardiogram</b> – An ECG, which you may have heard called a ‘heart tracing’ uses a machine to show pictures that tell us about the electrical signals in the heart muscle, hence the heart’s rhythm. A series of wires are connected to sticky pads attached to your chest and limbs, and these wires produce a reading on the machine. You won’t feel anything out of the ordinary, and certainly not any pain but you do have to remain still momentarily to give a clear reading.</p>",
        "id": 10,
        "system": [
            "cardio"
        ],
    ...
    },
    {
        ...
        "back": "<p>Mental State Examination (MSE) is an important part of gathering information from a psychiatric consultation. It comprises the following:</p><ul><li><b>General Appearance</b> – Age, gender, posture, dress, stigmata of disease</li><li><b>Behaviour</b> – Is it appropriate? Consider rapport and attitude</li><li><b>Speech</b> – Rate, articulation, vocabulary, volume, accent, latency</li><li><b>Mood</b> – Euthymic? Dysphoric? Apathetic? Euphoric?</li><li><b>Affect</b> – Reactive, flat or blunted?</li><li><b>Thought</b> – Process and content. Delusions? Obsessions?</li><li><b>Perception</b> – How does the patient view their self and their situation?</li><li><b>Cognition </b>– Memory, orientation, attention, calculation, language etc.</li><li><b>Insight</b> – The 4 As: Attribution, Awareness, Appraisal &amp; Acceptance</li></ul>",
        "id": 37,
        "system": [
            "psych"
        ],
    ...
    },
    {
        ...
        "back": "<p>Breaking bad news is a very individualised process and depends on the patient and their situation. Although there is no single way to break bad news the following guide (Buckman Framework) can be used to provide a framework from which to work.</p><ul><li><b>Getting Started</b> – Consider the physical context – quiet environment, no interruptions etc</li><li><b>How much does the patient already know? </b>Find out the background to the situation.</li><li><b>How much does the patient want to know?</b></li><li><b>Providing a warning shot</b> e.g <i>“I’m afraid the results are not what we had hoped for”</i></li><li><b>Sharing information</b> – Give appropriate amounts of information. Chunking and checking is helpful to check the patient’s understanding.</li><li><b>Respond to patient’s feelings sensitively</b> – acknowledge the emotion you see displayed e.g <i>“I can see you are upset, do you want to tell me what is going through your mind?”</i></li><li><b>Planning and follow up</b> – Shared decision making, coming up with a practical plan for patients around what will happen next.</li></ul>",
        "id": 39,
        "system": [
            ""
        ],
    ...
    },
    {
        ...
        "back": "<p><i>The most likely diagnosis is a microcytic anaemia, probably due to iron deficiency.</i></p><p>Anaemia is the name given to a group of conditions whereby the red blood cells’ ability to carry oxygen is poorer than would normally be expected. There are several different causes of anaemia but the likelihood is that a lack of iron in your body has lead to these results; we call this a ‘microcytic anaemia’ which basically means that when looked at down a microscope, your red blood cells are quite small in size.</p><p>One of the ways we can lose blood and not be aware of it is from our bowels. Therefore I would like to look into this anaemia further for you if that’s okay? It would be useful to carry out another couple of blood tests to look in more detail at your iron levels.</p><p>I would also like to refer you for an investigation which involves a camera or scope being passed in to your bowel through your bottom to look at the bowel in more detail. This will help identify any potential source of the blood loss. </p><p><i>NB: In female patients of reproductive age heavy periods maybe the cause and is worth exploring</i></p>",
        "id": 41,
        "system": [
            "haem"
        ],
